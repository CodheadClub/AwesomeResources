...
11. [Part 11: HOW TO: Install VMware Tools for Linux on a VMware Linux virtual machine on a VMware vSphere Hypervisor 7.0 (ESXi 7.0) Host Server - In Production - cutting room floor]
12. [Part 12: HOW TO: Install open-vm-tools for Linux on a VMware Linux virtual machine on a VMware vSphere Hypervisor 7.0 (ESXi 7.0) Host Server - In Production - cutting room floor]
13. [Part 13: HOW TO:  P2V a Windows XP computer to VMware vSphere Hypervisor 7.0 (ESXi 7.0) - In Production - cutting room floor]
14. [Part 14: HOW TO: Backup (Export) and Restore (Import) virtual machines to VMware vSphere Hypervisor 7.0 for FREE - In Production - cutting room floor]
15. [Part 15: HOW TO: Shrink or Reduce a VMware Virtual Machine Disk (VMDK) using VMware vCenter Converter Standalone v6 - In Production - cutting room floor]
